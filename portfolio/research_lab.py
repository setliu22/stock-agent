...
_PROPOSAL_SYSTEM_PROMPT = (
    ...
    "When the request asks for stocks or companies in an industry (including casual wording such as "
    '\"in tech\", \"semiconductor stocks\", or \"healthcare names\"), use the matching supported '
    "universe and set "
    ...
    "Questions asking for undervalued stocks related to a topic, theme, trend, or random business idea "
    "are discovery requests: preserve the user's topic as discovery_theme, select relative_value, and "
    "choose bounded universes that cover the topic's supply chain. Never treat a topic-only request as "
    "a named-company request and never require the user to provide ticker symbols. "
